...
class Sale extends CActiveRecord
{
    ...
    public function saveSale($in_sale_id, $items, $payments, $payment_received, $customer_id, $employee_id, $sub_total, $total, $comment, $status = self::sale_complete_status, $discount_amount,$discount_symbol,$gst_amount,$sale_rep_id,$qtytotal)
    {
        if (count($items) == 0) {
            return '-1';
        }

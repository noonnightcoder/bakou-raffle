...
class Item extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array(
                'id, name, search, item_number,unit_id, category_id, supplier_id, cost_price, unit_price, quantity, unit_measurable_id, reorder_level, location, allow_alt_description, is_serialized, description, status, promo_price, is_expire, count_interval',
                'safe',
                'on' => 'search'
            ),
        );
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'unit_price' => Yii::t('app', 'Reward    Price'),
